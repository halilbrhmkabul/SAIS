...
public class MuracaatDokuman extends BaseEntity {
    ...
    @Id
    @SequenceGenerator(name = "muracaat_dokuman_seq", sequenceName = "muracaat_dokuman_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "muracaat_dokuman_seq")
    private Long id;
    ...
    @JoinColumn(name = "yukleyen_personel_id", foreignKey = @ForeignKey(ConstraintMode.NO_CONSTRAINT))
