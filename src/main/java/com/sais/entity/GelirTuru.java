...
public class GelirTuru extends BaseEntity {
    ...
    @Id
    @SequenceGenerator(name = "gelir_turu_seq", sequenceName = "gelir_turu_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "gelir_turu_seq")
    private Long id;
