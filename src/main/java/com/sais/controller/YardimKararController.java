...
public class YardimKararController implements Serializable {
    ...
    private Long selectedYardimAltTipiId;  
    ...
    private Long selectedHesapBilgisiId;  
    ...
    private void addKarar() {
        try {
            ...
            Integer kararSayisi = null;
            LocalDate kararTarihi = null;
            
            if (komisyonKararli) {
               
                Integer sonKararSayisi = yardimService.getSonKararSayisi();
                kararSayisi = (sonKararSayisi != null ? sonKararSayisi : 0) + 1;
                kararTarihi = LocalDate.now();
                log.info("Komisyonlu karar oluşturuluyor - Yeni Karar Sayısı: {}, Karar Tarihi: {}", 
    ...
    public void addKomisyonsuzKarar() {
        ...
        try {
            ...
            log.info("Komisyonsuz karar builder sonrası - kararSayisi: {}, kararTarihi: {}", karar.getKararSayisi(), karar.getKararTarihi());
    ...
    public void kesinlestir() {
        try {
            ...
            log.info("Yardım kararları kesinleştirildi ve müracaat sonuçlandırıldı");
            
            
            muracaatService.findByIdWithAllDetails(muracaatId);
